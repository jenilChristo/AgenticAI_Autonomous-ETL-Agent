...
class LLMConfig:
    ...
    azure_endpoint: Optional[str] = "https://azureopenaijenil.openai.azure.com/"
...
class AgentConfig:
    ...
    def __post_init__(self):
        ...
        # GitHub Configuration - Set to target repository
        self.github.token = os.getenv("GITHUB_TOKEN")
        self.github.owner = os.getenv("GITHUB_OWNER", "jenilChristo")  # Default to target owner
        self.github.repo = os.getenv("GITHUB_REPO", "AgenticAI_Autonomous-ETL-Agent")  # Default to target repo
